...
export class Registry__addRecipientInputRecipientStruct extends ethereum.Tuple {
  get id(): Bytes {
...
export class Registry__getRecipientResultValue0Struct extends ethereum.Tuple {
  get id(): Bytes {
    return this[0].toBytes();
  }
...
export class Registry extends ethereum.SmartContract {
  ...
  addRecipient(recipient: Registry__addRecipientInputRecipientStruct): BigInt {
  ...
  try_addRecipient(
    recipient: Registry__addRecipientInputRecipientStruct,
  ...
  getRecipient(index: BigInt): Registry__getRecipientResultValue0Struct {
    let result = super.call(
      "getRecipient",
    ...
    return changetype<Registry__getRecipientResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getRecipient(
    index: BigInt,
  ): ethereum.CallResult<Registry__getRecipientResultValue0Struct> {
    let result = super.tryCall(
      "getRecipient",
      "getRecipient(uint256):((bytes32,string,address))",
      [ethereum.Value.fromUnsignedBigInt(index)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<Registry__getRecipientResultValue0Struct>(value[0].toTuple()),
    );
  }
